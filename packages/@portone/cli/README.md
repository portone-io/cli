...
[![license](https://img.shields.io/github/license/portone-io/cli)](https://github.com/portone-io/cli/blob/main/LICENSE)
...
- [Command reference](https://github.com/portone-io/cli/blob/main/docs/reference/index.md)
- [Usage examples](https://github.com/portone-io/cli/blob/main/docs/usage.md): payments, API requests, and shell completion
- [Configuration](https://github.com/portone-io/cli/blob/main/docs/configuration.md): authentication, profiles, stores, and language
...
VS Code Copilot, and OpenCode. See the [setup guide](https://github.com/portone-io/cli/blob/main/docs/setup.md)
for options and installation paths.

## Contributing

See the [development guide](https://github.com/portone-io/cli/blob/main/docs/development.md) to build from source
and update documentation. Report bugs and request features in
[GitHub Issues](https://github.com/portone-io/cli/issues).
