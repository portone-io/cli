...
[![라이선스](https://img.shields.io/github/license/portone-io/cli)](https://github.com/portone-io/cli/blob/main/LICENSE)
...
- [명령어 참조](https://github.com/portone-io/cli/blob/main/docs/reference/ko/index.md)
- [사용 예제](https://github.com/portone-io/cli/blob/main/docs/usage.ko.md): 결제, API 요청, 셸 자동완성
- [설정](https://github.com/portone-io/cli/blob/main/docs/configuration.ko.md): 인증, 프로필, 상점, 언어
...
옵션과 설치 경로는 [설정 안내](https://github.com/portone-io/cli/blob/main/docs/setup.ko.md)를 참고하세요.

## 기여

소스 빌드와 문서 수정은 [개발 안내](https://github.com/portone-io/cli/blob/main/docs/development.ko.md)를 참고하세요.
버그 제보와 기능 제안은 [GitHub Issues](https://github.com/portone-io/cli/issues)에 남겨주세요.
